module axi_ar_handshake_unit_2 (
    input           i_clk,
    input           i_rst_n,
    ...
    always @(*) begin
        case (ar_state_r)
            ...
            `K_proj : begin
                if (rot_cmd_cnt_r == 5'd3 && i_axi_arready && ar_cmd_cnt_r == 14'd2) begin
                    ar_state_w = `IDLE;
                end
                else begin
                    ar_state_w = ar_state_r;
            ...
            `Q_proj : begin
                if (rot_cmd_cnt_r == 5'd7 && i_axi_arready && ar_cmd_cnt_r == 14'd2) begin
                    ar_state_w = `IDLE;
                end
                else begin
                    ar_state_w = ar_state_r;
    ...
    always @(*) begin
        if (ar_state_r == `K_proj && i_axi_arready && rot_cmd_cnt_r == 5'd3 && ar_cmd_cnt_r == 14'd2) begin
            rot_cmd_cnt_w = 5'b0;
        end
        else if (ar_state_r == `Q_proj && i_axi_arready && rot_cmd_cnt_r == 5'd7 && ar_cmd_cnt_r == 14'd2) begin
            rot_cmd_cnt_w = 5'b0;
        end
        else if ((ar_state_r == `K_proj || ar_state_r == `Q_proj) && i_axi_arready && ar_cmd_cnt_r == 14'd2) begin
    ...
    always @(*) begin
        if ((ar_state_r == `K_proj || ar_state_r == `Q_proj) && ar_cmd_cnt_r == 14'd2 && i_axi_arready) begin
            ar_cmd_cnt_w = 14'b0;
        end
        ...
        else if ((ar_state_r == `V_proj || ar_state_r == `O_proj || ar_state_r == `Down_proj || ar_state_r == `L_proj || ar_state_r == `Mlp_proj) && i_axi_arready) begin
            ar_cmd_cnt_w = ar_cmd_cnt_r + 1'b1;
        end
        else begin
    ...
    always @(*) begin
        if (ar_state_r == `Embedding && i_axi_arready == 1'b1) begin
        ...
        else if (ar_state_r == `K_proj && i_axi_arready && rot_cmd_cnt_r == 5'd3 && ar_cmd_cnt_r == 14'd2) begin
            o_axi_arvalid_w = 1'b0;
            o_axi_arlen_w   = 8'd0;
        end
        else if (ar_state_r == `Q_proj && i_axi_arready && rot_cmd_cnt_r == 5'd7 && ar_cmd_cnt_r == 14'd2) begin
        ...
        else if ((i_cpu_cmd_vald_r == 1'b1 && (i_cpu_cmd_r == `K_proj || i_cpu_cmd_r == `Q_proj)) || ((ar_state_r == `K_proj || ar_state_r == `Q_proj) && i_axi_arready && ar_cmd_cnt_r == 14'd2)) begin
            o_axi_arvalid_w = 1'b1;
            o_axi_arlen_w   = `one_ar_bl;
        end
        else if ((ar_state_r == `K_proj || ar_state_r == `Q_proj) && i_axi_arready && ar_cmd_cnt_r == 14'd1) begin
            o_axi_arvalid_w = 1'b1;
    ...
    always @(*) begin
        if (ar_state_r == `Embedding && i_axi_arready == 1'b1) begin
            ...
            o_axi_araddr_w = o_axi_araddr_r + `key_slice_spacing_2;
        end
        else if ((ar_state_r == `K_proj || ar_state_r == `Q_proj) && i_axi_arready) begin
            o_axi_araddr_w = o_axi_araddr_r + `bl_256_spacing;
        end
