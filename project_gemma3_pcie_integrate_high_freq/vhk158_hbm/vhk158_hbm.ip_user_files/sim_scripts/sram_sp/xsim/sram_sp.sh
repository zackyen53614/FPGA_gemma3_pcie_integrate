...
#
# Script generated by Vivado on Sun Apr 19 22:01:14 CST 2026
...
#
# Usage        : sram_sp.sh
#                sram_sp.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                sram_sp.sh [-reset_run]
#                sram_sp.sh [-reset_log]
#                sram_sp.sh [-help]
#
...
# script info
echo -e "sram_sp.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./sram_sp.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb sram_sp.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./sram_sp.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: sram_sp.sh [-help]\n\
Usage: sram_sp.sh [-step]\n\
Usage: sram_sp.sh [-lib_map_path]\n\
Usage: sram_sp.sh [-reset_run]\n\
Usage: sram_sp.sh [-reset_log]\n\
Usage: sram_sp.sh [-keep_index]\n\
Usage: sram_sp.sh [-noclean_files]\n\n\
