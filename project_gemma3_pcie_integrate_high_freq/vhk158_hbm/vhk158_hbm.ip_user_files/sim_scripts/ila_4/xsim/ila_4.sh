...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L axis_dbg_stub_v1_0_1 -L xlconstant_v1_1_9 -L axis_dbg_sync_v1_0_1 -L axis_ila_intf_v1_0_2 -L axis_cap_ctrl_v1_0_1 -L axis_mu_v1_0_1 -L axis_itct_v1_0_1 -L axis_ila_pp_v1_0_2 -L axis_mem_v1_0_2 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ila_4 xil_defaultlib.ila_4 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ila_4 -key {Behavioral:sim_1:Functional:ila_4} -tclbatch cmd.tcl -protoinst "protoinst_files/fifo_2.protoinst" -protoinst "protoinst_files/bd_f29b.protoinst" -protoinst "protoinst_files/bd_aab3.protoinst" -protoinst "protoinst_files/bd_78ee.protoinst" -protoinst "protoinst_files/bd_b8bf.protoinst" -protoinst "protoinst_files/bd_7baa.protoinst" -protoinst "protoinst_files/bd_b84f.protoinst" -protoinst "protoinst_files/cpm_pcie.protoinst" -protoinst "protoinst_files/bd_6269.protoinst" -protoinst "protoinst_files/fifo_3.protoinst" -protoinst "protoinst_files/fifo_1.protoinst" -protoinst "protoinst_files/bram_group.protoinst" -protoinst "protoinst_files/bd_a2a8.protoinst" -protoinst "protoinst_files/bd_a3e8.protoinst" -protoinst "protoinst_files/sram_sp.protoinst" -protoinst "protoinst_files/sram_tp.protoinst" -protoinst "protoinst_files/bd_a028.protoinst" -log simulate.log
}
