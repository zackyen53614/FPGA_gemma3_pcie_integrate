...
#
# Script generated by Vivado on Fri Apr 17 05:07:31 CST 2026
...
#
# Usage        : fifo_1.sh
#                fifo_1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fifo_1.sh [-reset_run]
#                fifo_1.sh [-reset_log]
#                fifo_1.sh [-help]
#
...
#                script (type 'fifo_1.sh -help' for more information).
#
...
# script info
echo -e "fifo_1.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fifo_1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.fifo_1 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.fifo_1 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log fifo_1_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fifo_1.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fifo_1.sh [-help]\n\
Usage: fifo_1.sh [-step]\n\
Usage: fifo_1.sh [-lib_map_path]\n\
Usage: fifo_1.sh [-reset_run]\n\
Usage: fifo_1.sh [-reset_log]\n\
Usage: fifo_1.sh [-keep_index]\n\
Usage: fifo_1.sh [-noclean_files]\n\n\
