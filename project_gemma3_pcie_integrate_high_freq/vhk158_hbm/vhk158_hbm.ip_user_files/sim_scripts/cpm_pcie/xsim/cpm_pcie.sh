...
#
# Script generated by Vivado on Mon Apr 20 12:40:04 CST 2026
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : cpm_pcie.sh
...
#
# Usage        : cpm_pcie.sh
#                cpm_pcie.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                cpm_pcie.sh [-reset_run]
#                cpm_pcie.sh [-reset_log]
#                cpm_pcie.sh [-help]
#
...
# set xvlog options
xvlog_opts="--incr --relax  -L uvm -L emb_mem_gen_v1_0_10 -L pcie_qdma_mailbox_v1_0_8 -L axi_vip_v1_1_19 -L smartconnect_v1_0 -L cpm5_v1_0_17 -L cpm4_v1_0_17 -L emb_fifo_gen_v1_0_6 -L noc_hbm_nmu_sim_v1_0_0 -L noc_nmu_sim_v1_0_0 -L noc_nsu_sim_v1_0_0 -L noc_hbm_v1_0_1 -L versal_cips_ps_vip_v1_0_11 -L xilinx_vip"

# set xvhdl options
xvhdl_opts="--incr --relax "

# script info
echo -e "cpm_pcie.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./cpm_pcie.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb cpm_pcie.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./cpm_pcie.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: cpm_pcie.sh [-help]\n\
Usage: cpm_pcie.sh [-step]\n\
Usage: cpm_pcie.sh [-lib_map_path]\n\
Usage: cpm_pcie.sh [-reset_run]\n\
Usage: cpm_pcie.sh [-reset_log]\n\
Usage: cpm_pcie.sh [-keep_index]\n\
Usage: cpm_pcie.sh [-noclean_files]\n\n\
