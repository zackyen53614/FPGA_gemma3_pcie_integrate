...
(* CORE_GENERATION_INFO = "bd_7baa,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_7baa,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=56,numReposBlks=56,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=None}" *) (* HW_HANDOFF = "cpm_pcie_axis_ila_0_0.hwdef" *) 
module bd_7baa
   (SLOT_0_AXI_araddr,
    SLOT_0_AXI_arburst,
    SLOT_0_AXI_arcache,
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_BUSIF SLOT_0_AXI, ASSOCIATED_RESET resetn, CLK_DOMAIN bd_f29b_pspmc_0_0_pl0_ref_clk, FREQ_HZ 249997498, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input clk;
  ...
  wire axis_itct_cfg_din30;
  wire axis_itct_cfg_din31;
  wire axis_itct_cfg_din32;
  wire axis_itct_cfg_din33;
  ...
  wire axis_itct_cfg_en30;
  wire axis_itct_cfg_en31;
  wire axis_itct_cfg_en32;
  wire axis_itct_cfg_en33;
  ...
  wire [33:0]axis_itct_trigger_din;
  ...
  wire axis_mu21_0_cfg_dout;
  wire axis_mu21_0_match_out;
  wire axis_mu22_0_cfg_dout;
  wire axis_mu22_0_match_out;
  ...
  bd_7baa_axis_cap_ctrl_0 axis_cap_ctrl
  ...
  bd_7baa_axis_dbg_stub_0 axis_dbg_stub
  ...
  bd_7baa_axis_itct_0 axis_itct
       (.app_spec_i(axis_ila_intf_app_spec_o),
        ...
        .cfg_din30(axis_itct_cfg_din30),
        .cfg_din31(axis_itct_cfg_din31),
        .cfg_din32(axis_itct_cfg_din32),
        .cfg_din33(axis_itct_cfg_din33),
        ...
        .cfg_dout14(axis_mu14_0_cfg_dout),
        .cfg_dout15(axis_mu15_0_cfg_dout),
        .cfg_dout16(axis_mu16_0_cfg_dout),
        .cfg_dout17(axis_mu17_0_cfg_dout),
        .cfg_dout18(axis_mu18_0_cfg_dout),
        .cfg_dout19(axis_mu19_0_cfg_dout),
        .cfg_dout2(axis_mu2_0_cfg_dout),
        .cfg_dout20(axis_mu20_0_cfg_dout),
        .cfg_dout21(axis_mu21_0_cfg_dout),
        .cfg_dout22(axis_mu22_0_cfg_dout),
        .cfg_dout23(axis_mu23_0_cfg_dout),
        .cfg_dout24(axis_mu24_0_cfg_dout),
        .cfg_dout25(axis_mu25_0_cfg_dout),
        .cfg_dout26(axis_mu26_0_cfg_dout),
        .cfg_dout27(axis_mu27_0_cfg_dout),
        .cfg_dout28(axis_mu28_0_cfg_dout),
        .cfg_dout29(axis_mu29_0_cfg_dout),
        .cfg_dout3(axis_mu3_0_cfg_dout),
        .cfg_dout30(axis_mu30_0_cfg_dout),
        .cfg_dout31(axis_mu31_0_cfg_dout),
        .cfg_dout32(axis_mu32_0_cfg_dout),
        .cfg_dout33(axis_mu33_0_cfg_dout),
        ...
        .cfg_en30(axis_itct_cfg_en30),
        .cfg_en31(axis_itct_cfg_en31),
        .cfg_en32(axis_itct_cfg_en32),
        .cfg_en33(axis_itct_cfg_en33),
        ...
        .match_out14(axis_mu14_0_match_out),
        .match_out15(axis_mu15_0_match_out),
        .match_out16(axis_mu16_0_match_out),
        .match_out17(axis_mu17_0_match_out),
        .match_out18(axis_mu18_0_match_out),
        .match_out19(axis_mu19_0_match_out),
        .match_out2(axis_mu2_0_match_out),
        .match_out20(axis_mu20_0_match_out),
        .match_out21(axis_mu21_0_match_out),
        .match_out22(axis_mu22_0_match_out),
        .match_out23(axis_mu23_0_match_out),
        .match_out24(axis_mu24_0_match_out),
        .match_out25(axis_mu25_0_match_out),
        .match_out26(axis_mu26_0_match_out),
        .match_out27(axis_mu27_0_match_out),
        .match_out28(axis_mu28_0_match_out),
        .match_out29(axis_mu29_0_match_out),
        .match_out3(axis_mu3_0_match_out),
        .match_out30(axis_mu30_0_match_out),
        .match_out31(axis_mu31_0_match_out),
        .match_out32(axis_mu32_0_match_out),
        .match_out33(axis_mu33_0_match_out),
  ...
  bd_7baa_axis_mu0_0_0 axis_mu0_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_7baa_axis_mu10_0_0 axis_mu10_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_7baa_axis_mu11_0_0 axis_mu11_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_7baa_axis_mu12_0_0 axis_mu12_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_7baa_axis_mu13_0_0 axis_mu13_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_7baa_axis_mu14_0_0 axis_mu14_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_7baa_axis_mu15_0_0 axis_mu15_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_7baa_axis_mu16_0_0 axis_mu16_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_7baa_axis_mu17_0_0 axis_mu17_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_7baa_axis_mu18_0_0 axis_mu18_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_7baa_axis_mu19_0_0 axis_mu19_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_7baa_axis_mu1_0_0 axis_mu1_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_7baa_axis_mu20_0_0 axis_mu20_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_7baa_axis_mu21_0_0 axis_mu21_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        .cfg_din(axis_itct_cfg_din21),
        .cfg_dout(axis_mu21_0_cfg_dout),
        .cfg_en(axis_itct_cfg_en21),
        .clk(clk),
        .data_in(axis_ila_pp_probe21_out),
        .ila_resetn(axis_ila_intf_aresetn_out),
        .match_out(axis_mu21_0_match_out),
        .resetn(axis_dbg_stub_aresetn_int));
  bd_7baa_axis_mu22_0_0 axis_mu22_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        .cfg_din(axis_itct_cfg_din22),
        .cfg_dout(axis_mu22_0_cfg_dout),
        .cfg_en(axis_itct_cfg_en22),
        .clk(clk),
        .data_in(axis_ila_pp_probe22_out),
        .ila_resetn(axis_ila_intf_aresetn_out),
        .match_out(axis_mu22_0_match_out),
        .resetn(axis_dbg_stub_aresetn_int));
  bd_7baa_axis_mu23_0_0 axis_mu23_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_7baa_axis_mu24_0_0 axis_mu24_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_7baa_axis_mu25_0_0 axis_mu25_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_7baa_axis_mu26_0_0 axis_mu26_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_7baa_axis_mu27_0_0 axis_mu27_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_7baa_axis_mu28_0_0 axis_mu28_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_7baa_axis_mu29_0_0 axis_mu29_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_7baa_axis_mu2_0_0 axis_mu2_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_7baa_axis_mu30_0_0 axis_mu30_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        .cfg_din(axis_itct_cfg_din30),
        .cfg_dout(axis_mu30_0_cfg_dout),
        .cfg_en(axis_itct_cfg_en30),
        .clk(clk),
        .data_in(axis_ila_pp_probe30_out),
        .ila_resetn(axis_ila_intf_aresetn_out),
        .match_out(axis_mu30_0_match_out),
        .resetn(axis_dbg_stub_aresetn_int));
  bd_7baa_axis_mu31_0_0 axis_mu31_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        .cfg_din(axis_itct_cfg_din31),
        .cfg_dout(axis_mu31_0_cfg_dout),
        .cfg_en(axis_itct_cfg_en31),
        .clk(clk),
        .data_in(axis_ila_pp_probe31_out),
        .ila_resetn(axis_ila_intf_aresetn_out),
        .match_out(axis_mu31_0_match_out),
        .resetn(axis_dbg_stub_aresetn_int));
  bd_7baa_axis_mu32_0_0 axis_mu32_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        .cfg_din(axis_itct_cfg_din32),
        .cfg_dout(axis_mu32_0_cfg_dout),
        .cfg_en(axis_itct_cfg_en32),
        .clk(clk),
        .data_in(axis_ila_pp_probe32_out),
        .ila_resetn(axis_ila_intf_aresetn_out),
        .match_out(axis_mu32_0_match_out),
        .resetn(axis_dbg_stub_aresetn_int));
  bd_7baa_axis_mu33_0_0 axis_mu33_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        .cfg_din(axis_itct_cfg_din33),
        .cfg_dout(axis_mu33_0_cfg_dout),
        .cfg_en(axis_itct_cfg_en33),
        .clk(clk),
        .data_in(axis_ila_pp_probe33_out),
        .ila_resetn(axis_ila_intf_aresetn_out),
        .match_out(axis_mu33_0_match_out),
        .resetn(axis_dbg_stub_aresetn_int));
  bd_7baa_axis_mu3_0_0 axis_mu3_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_7baa_axis_mu4_0_0 axis_mu4_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_7baa_axis_mu5_0_0 axis_mu5_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_7baa_axis_mu6_0_0 axis_mu6_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_7baa_axis_mu7_0_0 axis_mu7_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_7baa_axis_mu8_0_0 axis_mu8_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_7baa_axis_mu9_0_0 axis_mu9_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_7baa_cc_axis_mu0_0 cc_axis_mu0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_7baa_cc_axis_mu1_0 cc_axis_mu1
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_7baa_cc_axis_mu2_0 cc_axis_mu2
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_7baa_cc_axis_mu3_0 cc_axis_mu3
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_7baa_slot_0_ar_0 slot_0_ar
       (.In0(SLOT_0_AXI_arvalid),
        .In1(SLOT_0_AXI_arready),
        .dout(slot_0_ar_dout));
  bd_7baa_slot_0_aw_0 slot_0_aw
       (.In0(SLOT_0_AXI_awvalid),
        .In1(SLOT_0_AXI_awready),
        .dout(slot_0_aw_dout));
  bd_7baa_slot_0_b_0 slot_0_b
       (.In0(SLOT_0_AXI_bvalid),
        .In1(SLOT_0_AXI_bready),
        .dout(slot_0_b_dout));
  bd_7baa_slot_0_r_0 slot_0_r
       (.In0(SLOT_0_AXI_rlast),
        .In1(SLOT_0_AXI_rvalid),
        .In2(SLOT_0_AXI_rready),
        .dout(slot_0_r_dout));
  bd_7baa_slot_0_w_0 slot_0_w
       (.In0(SLOT_0_AXI_wlast),
        .In1(SLOT_0_AXI_wvalid),
        .In2(SLOT_0_AXI_wready),
        .dout(slot_0_w_dout));
  bd_7baa_tc_axis_mu0_0 tc_axis_mu0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_7baa_xlconstant_0 xlconstant
