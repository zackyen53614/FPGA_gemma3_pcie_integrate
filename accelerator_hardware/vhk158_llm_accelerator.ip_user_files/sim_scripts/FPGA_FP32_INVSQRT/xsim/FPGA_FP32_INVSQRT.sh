...
#
# Script generated by Vivado on Sun Apr 19 02:34:18 CST 2026
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : FPGA_FP32_INVSQRT.sh
...
#
# Usage        : FPGA_FP32_INVSQRT.sh
#                FPGA_FP32_INVSQRT.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                FPGA_FP32_INVSQRT.sh [-reset_run]
#                FPGA_FP32_INVSQRT.sh [-reset_log]
#                FPGA_FP32_INVSQRT.sh [-help]
#
...
# script info
echo -e "FPGA_FP32_INVSQRT.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./FPGA_FP32_INVSQRT.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb FPGA_FP32_INVSQRT.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./FPGA_FP32_INVSQRT.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: FPGA_FP32_INVSQRT.sh [-help]\n\
Usage: FPGA_FP32_INVSQRT.sh [-step]\n\
Usage: FPGA_FP32_INVSQRT.sh [-lib_map_path]\n\
Usage: FPGA_FP32_INVSQRT.sh [-reset_run]\n\
Usage: FPGA_FP32_INVSQRT.sh [-reset_log]\n\
Usage: FPGA_FP32_INVSQRT.sh [-keep_index]\n\
Usage: FPGA_FP32_INVSQRT.sh [-noclean_files]\n\n\
