...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.FPGA_FP32_RECIP xil_defaultlib.glbl -o FPGA_FP32_RECIP_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./FPGA_FP32_RECIP_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key FPGA_FP32_RECIP_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc FPGA_FP32_RECIP_simv.daidir vcs_lib c.obj)
