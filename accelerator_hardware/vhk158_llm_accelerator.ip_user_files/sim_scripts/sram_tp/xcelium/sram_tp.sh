...
#
# Script generated by Vivado on Fri Apr 17 05:27:56 CST 2026
...
#
# Usage        : sram_tp.sh
#                sram_tp.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                sram_tp.sh [-reset_run]
#                sram_tp.sh [-reset_log]
#                sram_tp.sh [-help]
#
...
#                script (type 'sram_tp.sh -help' for more information).
#
...
# script info
echo -e "sram_tp.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./sram_tp.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.sram_tp xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.sram_tp -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log sram_tp_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./sram_tp.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: sram_tp.sh [-help]\n\
Usage: sram_tp.sh [-step]\n\
Usage: sram_tp.sh [-lib_map_path]\n\
Usage: sram_tp.sh [-reset_run]\n\
Usage: sram_tp.sh [-reset_log]\n\
Usage: sram_tp.sh [-keep_index]\n\
Usage: sram_tp.sh [-noclean_files]\n\n\
