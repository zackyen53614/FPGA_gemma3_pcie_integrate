...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L emb_mem_gen_v1_0_10 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot sram_tp xil_defaultlib.sram_tp xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim sram_tp -key {Behavioral:sim_1:Functional:sram_tp} -tclbatch cmd.tcl -protoinst "protoinst_files/fifo_2.protoinst" -protoinst "protoinst_files/bd_f29b.protoinst" -protoinst "protoinst_files/bd_aab3.protoinst" -protoinst "protoinst_files/bd_78ee.protoinst" -protoinst "protoinst_files/bd_b8bf.protoinst" -protoinst "protoinst_files/bd_7baa.protoinst" -protoinst "protoinst_files/bd_b84f.protoinst" -protoinst "protoinst_files/cpm_pcie.protoinst" -protoinst "protoinst_files/fifo_3.protoinst" -protoinst "protoinst_files/fifo_1.protoinst" -protoinst "protoinst_files/bram_group.protoinst" -protoinst "protoinst_files/sram_sp.protoinst" -protoinst "protoinst_files/sram_tp.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb sram_tp.wdb xsim.dir libdpi.so)
