...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.sram_tp xil_defaultlib.glbl -o sram_tp_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./sram_tp_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key sram_tp_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc sram_tp_simv.daidir vcs_lib c.obj)
