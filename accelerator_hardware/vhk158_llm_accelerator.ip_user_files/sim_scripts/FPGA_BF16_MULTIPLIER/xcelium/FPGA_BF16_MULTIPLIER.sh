...
#
# Script generated by Vivado on Fri Apr 17 02:58:31 CST 2026
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : FPGA_BF16_MULTIPLIER.sh
...
#
# Usage        : FPGA_BF16_MULTIPLIER.sh
#                FPGA_BF16_MULTIPLIER.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                FPGA_BF16_MULTIPLIER.sh [-reset_run]
#                FPGA_BF16_MULTIPLIER.sh [-reset_log]
#                FPGA_BF16_MULTIPLIER.sh [-help]
#
...
#                script (type 'FPGA_BF16_MULTIPLIER.sh -help' for more information).
#
...
# script info
echo -e "FPGA_BF16_MULTIPLIER.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./FPGA_BF16_MULTIPLIER.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.FPGA_BF16_MULTIPLIER xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.FPGA_BF16_MULTIPLIER -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log FPGA_BF16_MULTIPLIER_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./FPGA_BF16_MULTIPLIER.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: FPGA_BF16_MULTIPLIER.sh [-help]\n\
Usage: FPGA_BF16_MULTIPLIER.sh [-step]\n\
Usage: FPGA_BF16_MULTIPLIER.sh [-lib_map_path]\n\
Usage: FPGA_BF16_MULTIPLIER.sh [-reset_run]\n\
Usage: FPGA_BF16_MULTIPLIER.sh [-reset_log]\n\
Usage: FPGA_BF16_MULTIPLIER.sh [-keep_index]\n\
Usage: FPGA_BF16_MULTIPLIER.sh [-noclean_files]\n\n\
