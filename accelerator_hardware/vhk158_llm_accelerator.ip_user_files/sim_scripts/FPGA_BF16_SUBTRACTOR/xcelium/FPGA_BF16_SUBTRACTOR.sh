...
#
# Script generated by Vivado on Fri Apr 17 03:00:04 CST 2026
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : FPGA_BF16_SUBTRACTOR.sh
...
#
# Usage        : FPGA_BF16_SUBTRACTOR.sh
#                FPGA_BF16_SUBTRACTOR.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                FPGA_BF16_SUBTRACTOR.sh [-reset_run]
#                FPGA_BF16_SUBTRACTOR.sh [-reset_log]
#                FPGA_BF16_SUBTRACTOR.sh [-help]
#
...
#                script (type 'FPGA_BF16_SUBTRACTOR.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname xbip_utils_v3_0_14 -libname axi_utils_v2_0_10 -libname xbip_pipe_v3_0_10 -libname xbip_dsp48_wrapper_v3_0_6 -libname mult_gen_v12_0_22 -libname floating_point_v7_1_19 -libname xil_defaultlib -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm xbip_utils_v3_0_14 axi_utils_v2_0_10 xbip_pipe_v3_0_10 xbip_dsp48_wrapper_v3_0_6 mult_gen_v12_0_22 floating_point_v7_1_19 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "FPGA_BF16_SUBTRACTOR.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./FPGA_BF16_SUBTRACTOR.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"/tools/Xilinx/Vivado/2024.2/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"/tools/Xilinx/Vivado/2024.2/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work floating_point_v7_1_19 $xmvlog_opts +incdir+"/tools/Xilinx/Vivado/2024.2/Vivado/2024.2/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/floating_point_v7_1_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"/tools/Xilinx/Vivado/2024.2/Vivado/2024.2/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.FPGA_BF16_SUBTRACTOR xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.FPGA_BF16_SUBTRACTOR -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log FPGA_BF16_SUBTRACTOR_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./FPGA_BF16_SUBTRACTOR.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: FPGA_BF16_SUBTRACTOR.sh [-help]\n\
Usage: FPGA_BF16_SUBTRACTOR.sh [-step]\n\
Usage: FPGA_BF16_SUBTRACTOR.sh [-lib_map_path]\n\
Usage: FPGA_BF16_SUBTRACTOR.sh [-reset_run]\n\
Usage: FPGA_BF16_SUBTRACTOR.sh [-reset_log]\n\
Usage: FPGA_BF16_SUBTRACTOR.sh [-keep_index]\n\
Usage: FPGA_BF16_SUBTRACTOR.sh [-noclean_files]\n\n\
