...
#                script (type 'sram_sp.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname emb_mem_gen_v1_0_10 -libname xil_defaultlib -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm emb_mem_gen_v1_0_10 xil_defaultlib)
...
compile()
{
  ...
  xmvlog -work emb_mem_gen_v1_0_10 $xmvlog_opts -sv +incdir+"/tools/Xilinx/Vivado/2024.2/Vivado/2024.2/data/xilinx_vip/include" \
  "../../../../vhk158_llm_accelerator.gen/sources_1/bd/sram_sp/ipshared/0784/hdl/emb_mem_gen_v1_0_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts -sv +incdir+"/tools/Xilinx/Vivado/2024.2/Vivado/2024.2/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.sram_sp xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.sram_sp -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log sram_sp_sc.so .tmp_log xcelium_lib waves.shm c.obj)
