...
design_libs=(xilinx_vip xpm emb_mem_gen_v1_0_10 xil_defaultlib)
...
compile()
{
  ...
  vlogan -work emb_mem_gen_v1_0_10 $vlogan_opts -sverilog +incdir+"/tools/Xilinx/Vivado/2024.2/Vivado/2024.2/data/xilinx_vip/include" \
  "../../../../vhk158_llm_accelerator.gen/sources_1/bd/sram_sp/ipshared/0784/hdl/emb_mem_gen_v1_0_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"/tools/Xilinx/Vivado/2024.2/Vivado/2024.2/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.sram_sp xil_defaultlib.glbl -o sram_sp_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./sram_sp_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key sram_sp_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc sram_sp_simv.daidir vcs_lib c.obj)
