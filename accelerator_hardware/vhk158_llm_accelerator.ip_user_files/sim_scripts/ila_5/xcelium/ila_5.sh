...
#
# Script generated by Vivado on Fri Apr 17 05:44:03 CST 2026
...
#
# Usage        : ila_5.sh
#                ila_5.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ila_5.sh [-reset_run]
#                ila_5.sh [-reset_log]
#                ila_5.sh [-help]
#
...
#                script (type 'ila_5.sh -help' for more information).
#
...
# script info
echo -e "ila_5.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ila_5.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.ila_5 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.ila_5 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log ila_5_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: ila_5.sh [-reset_log]\n\
Usage: ila_5.sh [-keep_index]\n\
