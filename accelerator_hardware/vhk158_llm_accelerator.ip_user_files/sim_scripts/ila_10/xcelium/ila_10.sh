...
#
# Script generated by Vivado on Sun Apr 19 01:19:52 CST 2026
...
#
# Usage        : ila_10.sh
#                ila_10.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ila_10.sh [-reset_run]
#                ila_10.sh [-reset_log]
#                ila_10.sh [-help]
#
...
#                script (type 'ila_10.sh -help' for more information).
#
...
# script info
echo -e "ila_10.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ila_10.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.ila_10 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.ila_10 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log ila_10_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ila_10.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ila_10.sh [-help]\n\
Usage: ila_10.sh [-step]\n\
Usage: ila_10.sh [-lib_map_path]\n\
Usage: ila_10.sh [-reset_run]\n\
Usage: ila_10.sh [-reset_log]\n\
Usage: ila_10.sh [-keep_index]\n\
Usage: ila_10.sh [-noclean_files]\n\n\
