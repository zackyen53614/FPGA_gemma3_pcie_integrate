...
# set xvlog options
xvlog_opts="--incr --relax  -L emb_mem_gen_v1_0_10 -L pcie_qdma_mailbox_v1_0_8 -L axi_vip_v1_1_19 -L smartconnect_v1_0 -L cpm5_v1_0_17 -L cpm4_v1_0_17 -L emb_fifo_gen_v1_0_6 -L versal_cips_ps_vip_v1_0_11 -L xilinx_vip"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L axis_dbg_stub_v1_0_1 -L xlconstant_v1_1_9 -L axis_dbg_sync_v1_0_1 -L axis_ila_intf_v1_0_2 -L axis_cap_ctrl_v1_0_1 -L axis_mu_v1_0_1 -L axis_itct_v1_0_1 -L axis_ila_pp_v1_0_2 -L axis_mem_v1_0_2 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ila_10 xil_defaultlib.ila_10 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ila_10 -key {Behavioral:sim_1:Functional:ila_10} -tclbatch cmd.tcl -protoinst "protoinst_files/fifo_2.protoinst" -protoinst "protoinst_files/bd_f29b.protoinst" -protoinst "protoinst_files/bd_78ee.protoinst" -protoinst "protoinst_files/bd_b8bf.protoinst" -protoinst "protoinst_files/bd_7baa.protoinst" -protoinst "protoinst_files/bd_b84f.protoinst" -protoinst "protoinst_files/bd_6a72.protoinst" -protoinst "protoinst_files/cpm_pcie.protoinst" -protoinst "protoinst_files/bd_6269.protoinst" -protoinst "protoinst_files/fifo_3.protoinst" -protoinst "protoinst_files/bd_60e9.protoinst" -protoinst "protoinst_files/fifo_1.protoinst" -protoinst "protoinst_files/bd_a028.protoinst" -protoinst "protoinst_files/bram_group.protoinst" -protoinst "protoinst_files/bd_a2a8.protoinst" -protoinst "protoinst_files/bd_a3e8.protoinst" -protoinst "protoinst_files/bd_65e9.protoinst" -protoinst "protoinst_files/bd_a168.protoinst" -protoinst "protoinst_files/bd_61a9.protoinst" -protoinst "protoinst_files/bd_a528.protoinst" -protoinst "protoinst_files/sram_tp.protoinst" -protoinst "protoinst_files/sram_sp.protoinst" -protoinst "protoinst_files/bd_5aa3.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ila_10.wdb xsim.dir libdpi.so)
