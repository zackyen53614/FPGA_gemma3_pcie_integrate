...
#
# Script generated by Vivado on Fri Apr 17 05:17:44 CST 2026
...
#
# Usage        : fifo_3.sh
#                fifo_3.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fifo_3.sh [-reset_run]
#                fifo_3.sh [-reset_log]
#                fifo_3.sh [-help]
#
...
#                script (type 'fifo_3.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname emb_fifo_gen_v1_0_6 -libname xil_defaultlib -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm emb_fifo_gen_v1_0_6 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "fifo_3.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fifo_3.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvlog -work emb_fifo_gen_v1_0_6 $xmvlog_opts -sv +incdir+"/tools/Xilinx/Vivado/2024.2/Vivado/2024.2/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.fifo_3 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.fifo_3 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log fifo_3_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fifo_3.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fifo_3.sh [-help]\n\
Usage: fifo_3.sh [-step]\n\
Usage: fifo_3.sh [-lib_map_path]\n\
Usage: fifo_3.sh [-reset_run]\n\
Usage: fifo_3.sh [-reset_log]\n\
Usage: fifo_3.sh [-keep_index]\n\
Usage: fifo_3.sh [-noclean_files]\n\n\
