...
design_libs=(xilinx_vip xpm emb_fifo_gen_v1_0_6 xil_defaultlib)
...
compile()
{
  ...
  vlogan -work emb_fifo_gen_v1_0_6 $vlogan_opts -sverilog +incdir+"/tools/Xilinx/Vivado/2024.2/Vivado/2024.2/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.fifo_3 xil_defaultlib.glbl -o fifo_3_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./fifo_3_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key fifo_3_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc fifo_3_simv.daidir vcs_lib c.obj)
