...
#
# Script generated by Vivado on Sun Apr 19 02:32:59 CST 2026
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : FPGA_FP32_EXPONENT.sh
...
#
# Usage        : FPGA_FP32_EXPONENT.sh
#                FPGA_FP32_EXPONENT.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                FPGA_FP32_EXPONENT.sh [-reset_run]
#                FPGA_FP32_EXPONENT.sh [-reset_log]
#                FPGA_FP32_EXPONENT.sh [-help]
#
...
export RDI_DATADIR="/home/tools/Xilinx/Vivado/2024.2/Vivado/2024.2/data"

# set xvlog options
xvlog_opts="--incr --relax  -L emb_mem_gen_v1_0_10 -L pcie_qdma_mailbox_v1_0_8 -L axi_vip_v1_1_19 -L smartconnect_v1_0 -L cpm5_v1_0_17 -L cpm4_v1_0_17 -L emb_fifo_gen_v1_0_6 -L noc_hbm_nmu_sim_v1_0_0 -L noc_nmu_sim_v1_0_0 -L noc_nsu_sim_v1_0_0 -L noc_hbm_v1_0_1 -L versal_cips_ps_vip_v1_0_11 -L xilinx_vip"

# set xvhdl options
xvhdl_opts="--incr --relax "

# script info
echo -e "FPGA_FP32_EXPONENT.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./FPGA_FP32_EXPONENT.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L xbip_utils_v3_0_14 -L axi_utils_v2_0_10 -L xbip_pipe_v3_0_10 -L xbip_dsp48_wrapper_v3_0_6 -L mult_gen_v12_0_22 -L floating_point_v7_1_19 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot FPGA_FP32_EXPONENT xil_defaultlib.FPGA_FP32_EXPONENT xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim FPGA_FP32_EXPONENT -key {Behavioral:sim_1:Functional:FPGA_FP32_EXPONENT} -tclbatch cmd.tcl -protoinst "protoinst_files/fifo_2.protoinst" -protoinst "protoinst_files/bd_f29b.protoinst" -protoinst "protoinst_files/bd_78ee.protoinst" -protoinst "protoinst_files/bd_b8bf.protoinst" -protoinst "protoinst_files/bd_7baa.protoinst" -protoinst "protoinst_files/bd_b84f.protoinst" -protoinst "protoinst_files/bd_6a72.protoinst" -protoinst "protoinst_files/cpm_pcie.protoinst" -protoinst "protoinst_files/fifo_3.protoinst" -protoinst "protoinst_files/fifo_1.protoinst" -protoinst "protoinst_files/bram_group.protoinst" -protoinst "protoinst_files/sram_tp.protoinst" -protoinst "protoinst_files/sram_sp.protoinst" -protoinst "protoinst_files/bd_5aa3.protoinst" -protoinst "protoinst_files/bd_a528.protoinst" -protoinst "protoinst_files/bd_a168.protoinst" -protoinst "protoinst_files/bd_61a9.protoinst" -protoinst "protoinst_files/bd_65e9.protoinst" -protoinst "protoinst_files/bd_6269.protoinst" -protoinst "protoinst_files/bd_60e9.protoinst" -protoinst "protoinst_files/bd_a028.protoinst" -protoinst "protoinst_files/bd_a2a8.protoinst" -protoinst "protoinst_files/bd_a3e8.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/tools/Xilinx/Vivado/2024.2/Vivado/2024.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb FPGA_FP32_EXPONENT.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./FPGA_FP32_EXPONENT.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: FPGA_FP32_EXPONENT.sh [-help]\n\
Usage: FPGA_FP32_EXPONENT.sh [-step]\n\
Usage: FPGA_FP32_EXPONENT.sh [-lib_map_path]\n\
Usage: FPGA_FP32_EXPONENT.sh [-reset_run]\n\
Usage: FPGA_FP32_EXPONENT.sh [-reset_log]\n\
Usage: FPGA_FP32_EXPONENT.sh [-keep_index]\n\
Usage: FPGA_FP32_EXPONENT.sh [-noclean_files]\n\n\
