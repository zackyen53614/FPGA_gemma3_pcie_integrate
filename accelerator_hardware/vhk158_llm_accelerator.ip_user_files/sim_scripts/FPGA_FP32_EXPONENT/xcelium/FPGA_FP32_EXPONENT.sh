...
#                script (type 'FPGA_FP32_EXPONENT.sh -help' for more information).
#
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.FPGA_FP32_EXPONENT xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.FPGA_FP32_EXPONENT -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/zackyen/project_gemma3_pcie_integrate_noILA/vhk158_llm_accelerator/vhk158_llm_accelerator.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log FPGA_FP32_EXPONENT_sc.so .tmp_log xcelium_lib waves.shm c.obj)
