...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.bram_group xil_defaultlib.glbl -o bram_group_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./bram_group_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key bram_group_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc bram_group_simv.daidir vcs_lib c.obj)
