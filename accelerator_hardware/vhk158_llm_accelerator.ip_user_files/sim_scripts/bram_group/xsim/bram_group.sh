...
#
# Script generated by Vivado on Fri Apr 17 10:37:23 CST 2026
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : bram_group.sh
...
#
# Usage        : bram_group.sh
#                bram_group.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                bram_group.sh [-reset_run]
#                bram_group.sh [-reset_log]
#                bram_group.sh [-help]
#
...
# script info
echo -e "bram_group.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./bram_group.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L emb_mem_gen_v1_0_10 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot bram_group xil_defaultlib.bram_group xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim bram_group -key {Behavioral:sim_1:Functional:bram_group} -tclbatch cmd.tcl -protoinst "protoinst_files/fifo_2.protoinst" -protoinst "protoinst_files/bd_f29b.protoinst" -protoinst "protoinst_files/bd_aab3.protoinst" -protoinst "protoinst_files/bd_78ee.protoinst" -protoinst "protoinst_files/bd_b8bf.protoinst" -protoinst "protoinst_files/bd_7baa.protoinst" -protoinst "protoinst_files/bd_b84f.protoinst" -protoinst "protoinst_files/cpm_pcie.protoinst" -protoinst "protoinst_files/bd_6269.protoinst" -protoinst "protoinst_files/fifo_3.protoinst" -protoinst "protoinst_files/bd_60e9.protoinst" -protoinst "protoinst_files/fifo_1.protoinst" -protoinst "protoinst_files/bd_a028.protoinst" -protoinst "protoinst_files/bram_group.protoinst" -protoinst "protoinst_files/bd_a2a8.protoinst" -protoinst "protoinst_files/bd_a3e8.protoinst" -protoinst "protoinst_files/sram_tp.protoinst" -protoinst "protoinst_files/sram_sp.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb bram_group.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./bram_group.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: bram_group.sh [-help]\n\
Usage: bram_group.sh [-step]\n\
Usage: bram_group.sh [-lib_map_path]\n\
Usage: bram_group.sh [-reset_run]\n\
Usage: bram_group.sh [-reset_log]\n\
Usage: bram_group.sh [-keep_index]\n\
Usage: bram_group.sh [-noclean_files]\n\n\
