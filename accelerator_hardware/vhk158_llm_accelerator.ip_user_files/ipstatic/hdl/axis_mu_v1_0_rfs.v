...
module axis_mu_v1_0_1_allx_carry_logic #(
  ...
  `include "axis_mu_v1_0_1_mu_pkg.vh"
...
module axis_mu_v1_0_1_mu_eq_edge #(
   parameter C_WIDTH   = 32,
   parameter C_EN_WIDTH = 16,
   parameter C_EN_PIPE = 0
  ) (
...
module axis_mu_v1_0_1_axis_mu #(
  ...
  reg  [1:0]                next_state;
  reg                       cfg_data;
  wire [C_WIDTH-1:0] data_in_i;

  assign mu_en = cfg_en_temp & en;
  //assign data_in_i = (arm == 1'b1) ? data_in : 'h0;
  assign data_in_i = data_in;
    ...
    begin: MU_EQ_EDGE
      ...
      begin: L2_NFULL
        axis_mu_v1_0_1_mu_eq_edge #(
          ...
          .g_and_or   (drive_o5),
          .clk        (clk),
          .data_in    (data_in_i[C_WIDTH-1:(LC_FULL_32BIT_BLOCK*32)]),
    ...
    begin: MU_EQ
      ...
      begin: L2_NFULL
        axis_mu_v1_0_1_mu_eq #(
          ...
          .g_and_or   (drive_o5),
          .clk        (clk),
          .data_in    (data_in_i[C_WIDTH-1:(LC_FULL_80BIT_BLOCK*80)]),
  ...
  generate
    ...
    begin: ALLX
      ...
      axis_mu_v1_0_1_allx_carry_logic #(
