`timescale 1 ns / 1 ps
module axis_cap_ctrl_v1_0_1_axis_cap_ctrl
 #(
...
*/
  ...
  reg                                capture_i     = 1'b0;
  reg                                capture_adv   = 1'b0;
  reg                                sqc_wr_scnt_0 = 1'b0;
  reg                                update_temp   = 1'b0;
  reg                                incr_lwcnt    = 1'b0;

  reg armed_dly1_sm   = 1'b0,
      wcnt_hcmp_q     = 1'b0,
      wcnt_lcmp_q     = 1'b0,
      scnt_cmp_q      = 1'b0,
      scnt_max_cmp_q  = 1'b0,
  ...
  begin
    if (en_adv_trigger_i == 1'b1)
    begin
      capture_adv <= capture_i;
    end
    else
    begin
      capture_adv <= 1'b0;
  ...
  // Mahesh logic to fix sqc
  always @ (posedge ila_clk)
  begin
    armed_dly1_sm <= armed;
    armed_dly2_sm <= armed_dly1_sm;
    armed_dly3_sm <= armed_dly2_sm;
  end

  assign armed_edge = armed_dly2_sm && !armed_dly3_sm;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        begin
          if (scnt_max_cmp_q == 1'b1 & scnt_rst_dly == 1'b1)
          begin
            flag <= 1'b1;
          end
        end
 ...
 endgenerate
  ...
  axis_cap_ctrl_v1_0_1_case1
   ...
   (
      ...
      .trig_i(trigger_temp),
      .aresetn_i(aresetn),
      .capture_i((en_adv_trigger_i == 1'b0) ? capture_i : capture_adv),
...
`timescale 1 ns / 1 ps
module axis_cap_ctrl_v1_0_1_case1
 #(
   parameter C_CNT_WIDTH = 8
  )
 (
...
`timescale 1 ns / 1 ps
module axis_cap_ctrl_v1_0_1_case2
 #(
   parameter C_CNT_WIDTH = 8
  )
 (
...
`timescale 1 ns / 1 ps
module axis_cap_ctrl_v1_0_1_case3
 #(
   parameter C_CNT_WIDTH = 8
  )
 (
...
`timescale 1 ns / 1 ps
module axis_cap_ctrl_v1_0_1_case4
 #(
   parameter C_CNT_WIDTH = 8
  )
 (
...
`timescale 1 ns / 1 ps
module axis_cap_ctrl_v1_0_1_case5
 #(
   parameter C_CNT_WIDTH = 8
  )
  (
...
`timescale 1 ns / 1 ps
module axis_cap_ctrl_v1_0_1_case6
 #(
   parameter C_CNT_WIDTH = 8
  )
  (
...
`timescale 1 ns / 1 ps
module axis_cap_ctrl_v1_0_1_case7
 #(
   parameter C_CNT_WIDTH = 8
  )
 (
...
`timescale 1 ns / 1 ps
module axis_cap_ctrl_v1_0_1_case8
 #(
   parameter C_CNT_WIDTH = 8
  )
 (
